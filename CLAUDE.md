...
- ORM: Drizzle ORM → Turso/LibSQL (SQLite dialect), local fallback `sqlite.db`
...
- Run locally: `bun run dev` (port 3000)
- DB migrations generate: `npx drizzle-kit generate`
- DB migrations apply: `npx drizzle-kit migrate`

### Layout
- Source lives in: `src/`
- Routes (file-based): `src/routes/`
- Components: `src/components/` (ui, dashboard, inventory, kategori, layout, permintaan, users)
- Server functions: `src/server/functions/`
- DB schema + instance: `src/db/`
- Shared UI components: `src/components/ui/`
- Do not modify: `src/routeTree.gen.ts` (auto-generated by TanStack Router)

### Conventions specific to this repo
- Biome: tabs, double quotes. Excludes `src/routeTree.gen.ts` and `src/styles.css`
- TypeScript: `noUnusedLocals`, `noUnusedParameters`, `@/*` path alias maps to `./src/*`
...
- Secrets/keys in source: never commit env vars or tokens
