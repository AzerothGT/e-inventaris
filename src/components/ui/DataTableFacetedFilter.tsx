    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute left-0 mt-2 w-48 rounded-xl bg-white p-1 shadow-lg border border-surface-200 z-50">
            {options.map((option) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected ? "bg-surface-50 text-primary-600" : "text-surface-600"
                  )}
                  onClick={() => {
                    if (isSelected) {
            ...
            {selectedValues.size > 0 && (
              <>
                ...
                <button
                  ...
                  className="relative flex w-full cursor-default select-none items-center rounded-lg px-2 py-1.5 text-sm text-center justify-center hover:bg-surface-100 text-danger-500 font-medium"
                >
                  Hapus Filter
                </button>
              </>
