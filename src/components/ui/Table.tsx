...
>(({ className, ...props }, ref) => (
	<thead
		ref={ref}
		className={cn("bg-surface-100 [&_tr]:border-b", className)}
		{...props}
	/>
));
...
>(({ className, ...props }, ref) => (
	<tr
		ref={ref}
		className={cn(
			"border-surface-200 border-b transition-colors hover:bg-surface-50/50 data-[state=selected]:bg-surface-100",
			className,
		)}
		{...props}
	/>
