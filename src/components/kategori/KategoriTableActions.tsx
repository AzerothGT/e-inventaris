			...
			>
				<div className="py-2">
					<KategoriForm
						...
						onSubmit={(data) =>
							updateMutation.mutate({ data: { id: kategori.id, ...data } })
						}
			...
			>
				<div className="space-y-4 py-2">
					<p className="text-sm text-surface-600">
						...
						<strong>{kategori.nama}</strong>? Kategori yang masih digunakan oleh
						barang atau item pengadaan tidak dapat dihapus.
					</p>
					<div className="flex justify-end gap-3 pt-4">
						...
						<Button
							variant="destructive"
							onClick={() =>
								deleteMutation.mutate({ data: { id: kategori.id } })
							}
